...
def request_paper_rewrite(problem_id: str, reason: str, question_id: str | None = None,
                          summary_review: str | None = None) -> dict:
    ...
    if evidence['evidence_hash'] != previous.get('evidence_hash'):
        ...
        from .paper_integrity import verify_summary_review
        review_record = verify_summary_review(ROOT / summary_review,
            problem_dir(problem_id) / 'paper/reviews', previous.get('evidence_hash'), evidence)
    ...
    if review_record:
        problem['paper'].update(summary_review=summary_review, summary_review_record=review_record)
